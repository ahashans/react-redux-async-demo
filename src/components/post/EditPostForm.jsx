...
const PostForm = ({ updatePost, postToEdit, toggleEditView }) => {
  const [post, setPost, resetPost] = usePostState(postToEdit);
...
export default connect(null, { updatePost })(PostForm);
